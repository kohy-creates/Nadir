...
execute if score @s nadir.misc matches 100 run function nadir:magma_walker/obsidian_to_crying_obsidian
execute if score @s nadir.misc matches 140 run function nadir:magma_walker/disappear
